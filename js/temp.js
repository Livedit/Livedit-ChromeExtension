        ...
        DebuggerProtocolBackedDom: {get: function () {
            ...
            r = (function () {
                ...
                return Kotlin.createClass([Kotlin.modules['browser-ext-platform'].com_jetbrains_browserConnection.Dom, Kotlin.modules['browser-ext-platform'].org_jetbrains_util.Disposable], function (debuggee) {
                    ...
                    findNode: {
                        value: function (selector, selectorSubject, callback) {
                    ...
                    findStyleSheet: {
                        value: function (sourceUrls, callback) {
                            this.css.getStyleSheets($f6.bind(this, sourceUrls, callback));
                        }
                    },
                    setOuterHtml: {
                        value: function (selector, selectorSubject, outerHtml) {
                            this.findNode(selector, selectorSubject, $f9.bind(this, outerHtml));
                        }, writable: true
                    },
                    setOuterHtml$0: {
                        value: function (nodeId, outerHtml, callback) {
                            if (callback === undefined)
                                callback = null;
                    ...
                    setProperty: {
                        value: function (selector, selectorSubject, name, value, isStyle) {
                    ...
                    highlightElement: {
                        value: function (selector, selectorSubject) {
